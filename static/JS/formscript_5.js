...
$(document).on("click",".add-class-4",function (e){
    e.preventDefault();
    var total_forms=parseInt($("#id_step5-TOTAL_FORMS").val());
    ...
    if(total_forms<=6){
            ...
            $(clone_row_output).find(".form-field-output-4").each(
                function () {
                    ...
                    var regular_exp1 = new RegExp('(' + 'step5' + '-\\d+-)');
                    var replacement1 = "step5-" + total_forms + "-";
            ...
            $("#id_step5-TOTAL_FORMS").val(total_forms + 1);
        }
        else{
            console.log(total_forms);
        }
